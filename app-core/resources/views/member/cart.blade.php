...
@section('content')
    ...
    <div class="container-fluid page-header py-5"
        ...
        <h1 class="text-center text-white display-6" style="position: relative; z-index: 2;">Keranjang</h1>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
                        ...
                        <tr>
                            <th scope="row">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('storage/img/product/cutting/product-1.jpg')}}" class="img-fluid me-5 square-circle"
                                        style="width: 80px; height: 80px;" alt="">
                                </div>
                            </th>
                            <td>
                                <p class="mb-0 mt-4">Electric Scissors</p>
                            </td>
                            <td>
                                <p class="mb-0 mt-4">Rp 66.000</p>
                            </td>
                            <td>
            ...
            <div class="mt-5">
                ...
                <button class="btn border-secondary rounded-pill px-4 py-3 text-primary" type="button">Masukkan Kupon</button>
            </div>
            <div class="row g-4 justify-content-end">
                ...
                <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                    <div class="bg-light rounded">
                        <div class="p-4">
                            <h3 class="display-12 mb-4">Total <span class="fw-normal">Pembelian</span></h3>
                            <div class="d-flex justify-content-between mb-4">
                                <h5 class="mb-0 me-4">Subtotal:</h5>
                                <p class="mb-0">Rp 198.000</p>
                            </div>
                            ...
                            <p class="mb-0 text-end">Pengiriman ke Depok.</p>
                        </div>
                        <div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                            <h5 class="mb-0 ps-4 me-4">Total</h5>
                            <p class="mb-0 pe-4">Rp 218.000</p>
                        </div>
