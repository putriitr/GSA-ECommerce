        ...
        <div class="d-flex justify-content-between">
            <div class="top-info ps-2">
                <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#"
                        class="text-white">{{ $parameter->location }}</a></small>
                <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a
                        href="mailto:{{ $parameter->email }}" class="text-white">{{ $parameter->email }}</a></small>
                <small class="me-3"><i class="fas fa-phone me-2 text-secondary"></i><a
                        href="https://wa.me/{{ $parameter->phone }}"
                        class="text-white">{{ $parameter->phone }}</a></small>
            </div>
            <div class="top-link pe-2">
                <a href="#" class="text-white"><small
                        class="text-white mx-2">{{ $parameter->tagline }}</small>|</a>
            </div>
        </div>
    </div>
                ...
                <div class="d-flex m-3 me-0">
                    ...
                    <a href="{{ route('wishlist') }}" class="position-relative me-4 my-auto">
                        ...
                        <span
                            ...
                            style="top: -5px; left: 22px; height: 20px; min-width: 20px;">5</span>
                    </a>
                    <a href="{{ route('cart') }}" class="position-relative me-4 my-auto">
                        <i class="fa fa-shopping-cart fa-2x"></i>
                        <span
                            class="position-absolute bg-secondary rounded-circle d-flex align-items-center justify-content-center text-dark px-1"
                            style="top: -5px; left: 25px; height: 20px; min-width: 20px;">3</span>
                    </a>
